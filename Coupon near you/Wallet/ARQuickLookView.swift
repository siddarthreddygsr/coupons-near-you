...
//        let scene = SCNScene(named: "wateringcan.usdz") // Change to your USDZ file's name
//        sceneView.scene = scene
//        sceneView.autoenablesDefaultLighting = true
//        sceneView.allowsCameraControl = true // Enable camera control
//
//        return sceneView
//    }
//
...
struct ARQuickLookView_Previews: PreviewProvider {
    static var previews: some View {
        ARQuickLookView(name: "wateringcan")
    }
}
